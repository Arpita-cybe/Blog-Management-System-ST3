...
const EditPost = () => {
    ...
    const deleteCategory = (i) => {
        ...
        updatedCats.splice(i, 1); // Corrected to remove the category at index i
        setCats(updatedCats);
    };
    ...
    return (
        <div style={{ backgroundColor: "#f9f3e9", color: "#333" }}> {/* Set background color here */}
            <Navbar />
            <div className='px-6 md:px-[200px] mt-8'>
                <h1 className='font-bold md:text-2xl text-xl'>Update a post</h1>
                {/* Line below the title */}
                <div style={{ borderBottom: "2px solid #ffcc80", margin: "10px 0", width: "100%" }}></div>
